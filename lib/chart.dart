...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ...
      ExpenseBucket.forCatagory(expenses, CAtagory.Medical),
      ExpenseBucket.forCatagory(expenses, CAtagory.Rent),
      ExpenseBucket.forCatagory(expenses, CAtagory.Shopping),
      ExpenseBucket.forCatagory(expenses, CAtagory.Transport),
